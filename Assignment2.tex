...
\node[squarednode]      (S0)                              {0};
\node[roundnode]        (S1)       [above right=2cm of S0] { 1};
\node[squarednode]      (S3)       [right=4cm of S0] {3};
\node[roundnode]        (S2)       [below right=2cm of S0] { 2};
\node[roundnode]        (S4)       [above right=2cm of S3] { 4};
\node[roundnode]        (S5)       [below right=2cm of S3] { 5};
