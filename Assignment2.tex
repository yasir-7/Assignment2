...
\begin{align}
    &S = \Bigl\{(3,1) ,(3,2) ... ,(3,6), (6,1) ... ,(6,6) ,(1,T) ,(2,T) ,(4,T) ,(5,T) (1,H) ,(2,H) ,(4,H) ,(5,H)\}
\end{align}
Now, 
\begin{enumerate}
    \item Let A be an event such that 'The coin shows a tail' .
    \begin{align}
    \label{eq:1}
    &A = \Bigl\{(1,T) ,(2,T) ,(4,T) ,(5,T)\}
    \end{align}
    \item Let B be an event such that 'At least one die shows a 3' .
    \begin{align}
    \label{eq:2}
    &B = \Bigl\{(3,1) ,(3,2) ,(3,3) ,(3,4) ,(3,5) ,(3,6) ,(6,3) \}
    \end{align}
\end{enumerate}
To Find,
\begin{align}
...
\begin{align}
  ...
  \label{eq:4}
   \implies \pr{AB} &= 0 
 \end{align}
 Putting the value from \eqref{eq:4} in \eqref{eq:3},
 \begin{align}
\pr{A\mid B} &= \frac{(0)}{\pr{B}}\\
\implies \pr{A\mid B} &= 0 
\end{align}
\end{document} 
